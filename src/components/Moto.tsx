...
export default function Moto() {
  return (
    <section id="moto" className="bg-[#c6c2b6] py-20 px-8 md:px-16 flex items-center justify-center relative overflow-hidden">
      <motion.div 
      ...
      >
        ...
        <div className="absolute -inset-4 sm:-inset-6 rounded-[3rem] sm:rounded-[4rem] bg-white opacity-50 group-hover:opacity-80 blur-3xl transition duration-1000"></div>
